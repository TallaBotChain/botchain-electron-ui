  ...
  render() {
    ...
    return (
      <form onSubmit={handleSubmit}>
        ...
        <Field name="amount" type="text" component={inputField} label={this.props.label} placeholder="Amount" validate={[required(), numericality({ '>': 0, '<=': this.props.walletData.balance })]} />
        <Row>
          <Col xs={12}>
            <Row>
