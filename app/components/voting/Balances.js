      ...
      <div className='voting-balances'>
        <Row>
          <Col xs={12} className="white-header text-center">
            <p className="gray-text">
              <small>Staked Balance:</small> {round(this.props.curationCouncil.stakedBalance)} <span>BOTC</span>
            </p>
          </Col>
        </Row>
        <Row className="text-center">
          <Col xs={6} className="gray-border">
            ...
            <h1 className="botcoin-green">{round(this.props.voting.rewardBalance)}<span className="botcoin-title">BOTC</span></h1>
          ...
          <Col xs={6} className="gray-border">
            ...
            <h1 className="botcoin-green">{round(this.props.voting.availableReward)}<span className="botcoin-title">BOTC</span></h1>
          </Col>
